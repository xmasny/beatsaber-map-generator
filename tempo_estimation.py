...
for i in range(20):
    ...
    tempo_compare.append(
        (original_tempo, round(tempo, 2), round(tempo_difference, 2), round(tempo_difference_percentage, 2)))
...
pd.DataFrame(tempo_compare, columns=["Original tempo", "Estimated tempo", "Tempo difference",
             "Tempo difference percentage"]).to_csv("tempo_compare.csv", index=False)
